...
const SEARCH_DOCUMENT = 'approval/SEARCH_DOCUMENT'

export const { approval : { registVacation, registResign, registReason, 
                            selectEmployee, searchEmployee, searchDepartment
                            ,searchDocument } } = createActions({
...
const approvalReducer = handleActions({
    ...
    [SEARCH_DOCUMENT] : (state, {payload}) => ({ document : payload })
}, initialState) 
